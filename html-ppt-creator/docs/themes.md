...
Every theme is a short CSS file in `design-system/themes/` that overrides tokens
defined in `design-system/tokens.css`. Switch themes by changing the `href` of
...
```html
<link rel="stylesheet" id="theme-link" href="../design-system/themes/aurora.css">
```

Or enable `T`-cycling by listing themes on the body:

```html
<body data-themes="minimal-white,aurora,catppuccin-mocha" data-theme-base="../design-system/themes/">
```
