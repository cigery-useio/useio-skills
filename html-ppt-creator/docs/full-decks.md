...
Self-contained multi-slide HTML decks under `deck-templates/full-decks/<name>/`. Each folder contains:
...
All templates pull the shared `design-system/typography.css`, `design-system/tokens.css`, and `design-system/deck-runtime.js` from the skill root. Navigate with `← →` / `space`, use `F` for fullscreen, `O` for overview.
...
- **Path:** `deck-templates/full-decks/xhs-white-editorial/index.html`
...
- **Path:** `deck-templates/full-decks/graphify-dark-graph/index.html`
...
- **Path:** `deck-templates/full-decks/knowledge-arch-blueprint/index.html`
...
- **Path:** `deck-templates/full-decks/hermes-cyber-terminal/index.html`
...
- **Path:** `deck-templates/full-decks/obsidian-claude-gradient/index.html`
...
- **Path:** `deck-templates/full-decks/testing-safety-alert/index.html`
...
- **Path:** `deck-templates/full-decks/xhs-pastel-card/index.html`
...
- **Path:** `deck-templates/full-decks/dir-key-nav-minimal/index.html`
...
- The shared runtime (`design-system/deck-runtime.js`) provides keyboard nav, fullscreen, overview grid, theme cycling — you don't need to add any JS.
