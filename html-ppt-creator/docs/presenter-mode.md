...
这份文档说明如何在 html-ppt-creator skill 里做出**带逐字稿的演讲者模式 PPT**。
...
```bash
cp -r deck-templates/full-decks/presenter-mode-reveal examples/my-talk
```
...
2. **确认 HTML 引入了 `design-system/deck-runtime.js`**
...
<head>
  ...
  <link rel="stylesheet" id="theme-link" href="../../../design-system/themes/tokyo-night.css">
  <link rel="stylesheet" href="../../../design-system/motion/animations.css">
...
<script src="../../../design-system/deck-runtime.js"></script>
</body>
</html>
```
...
没有 `<script src="../../../design-system/deck-runtime.js"></script>` = 没有 S 键、没有演讲者视图、没有翻页。
